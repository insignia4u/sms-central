...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        dragText: (Modernizr.draganddrop &&  !$.browser.msie) ? 'Drag your file here or click browse to upload' : 'Browse files to upload',
        extraDropzones : [],
        hideDropzones : true,
        ...
        fileTemplate: '<li>' +
            '<div class="qq-progress-bar-container"><div class="qq-progress-bar"></div></div>' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _setupDragDrop: function(){
        ...
        if (!this._options.disableDefaultDropzone && !qq.ie()) {
            this._attach(document, 'dragenter', function(e){
                ...
                for (i=0; i < dropzones.length; i++){ dropzones[i].style.display = 'inline-block'; }
    ...
    _onComplete: function(id, fileName, result){
        ...
        qq.remove(this._find(item, 'progressBarContainer'));
